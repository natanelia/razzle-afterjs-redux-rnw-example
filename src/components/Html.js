...
class CustomDocument extends React.Component {
  ...
  render() {
    const { helmet, assets, data, rnwCss } = this.props;
      ...
      <html {...htmlAttrs}>
        <head>
          ...
          {process.env.NODE_ENV === 'production' ? (
            <span dangerouslySetInnerHTML={{ __html: `<script src="${assets.client.js}" defer></script>`}} />
          ) : (
            <span dangerouslySetInnerHTML={{ __html: `<script src="${assets.client.js}" defer crossorigin></script>`}} />
          )}
